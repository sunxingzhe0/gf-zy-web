  ...
  <el-tabs v-if="id" v-model="activeName" type="border-card">
      ...
      >
        ...
        <el-row class="view__content" :gutter="20">
          ...
          <el-col :md="12">
            <el-form-item
              label="是否本院"
              :prop="model.type === 'OTHER' ? '' : 'inHospital'"
            >
              <el-select
                style="width: 100%"
          ...
          <el-col :md="12">
            <el-form-item
              label="是否推荐"
              :prop="model.type === 'OTHER' ? '' : 'recommend'"
            >
              <el-select
                style="width: 100%"
          ...
          <el-col :md="12">
            <el-form-item
              label="执业经历"
              :prop="model.type === 'OTHER' ? '' : 'practiceInfo'"
            >
              <el-input
          ...
          <el-col :md="12">
            <el-form-item
              label="学术经历"
              :prop="model.type === 'OTHER' ? '' : 'academicInfo'"
            >
              <el-input
    ...
    <el-tab-pane label="实名信息" name="auth">
      ...
      >
        ...
        <el-form-item label="性别" :prop="model.type === 'OTHER' ? '' : 'sex'">
          <el-select
            style="width: 100%"
            v-model="model.sex"
            v-show="!model.idCard"
      ...
      >
        <el-row class="view__content" :gutter="20">
          ...
          <el-col>
            <el-form-item
              label="执业范围"
              :prop="model.type === 'OTHER' ? '' : 'practiceArea'"
            >
              <el-input
  ...
  >
    ...
    <el-row class="view__content" :gutter="20">
      ...
      <el-col :md="12">
        <el-form-item
          label="默认科室"
          :prop="model.type === 'OTHER' ? '' : 'defDeptId'"
        >
      ...
      <el-col :md="12">
        <el-form-item
          label="职务"
          :prop="model.type === 'OTHER' ? '' : 'position'"
        >
      ...
      <el-col :md="12">
        <el-form-item
          label="从业年限"
          :prop="model.type === 'OTHER' ? '' : 'workHistory'"
        >
          <el-date-picker
            v-model="model.workHistory"
            type="date"
      ...
      <el-col :md="12">
        <el-form-item label="邮箱" :prop="model.type === 'OTHER' ? '' : 'mail'">
          <el-input v-model="model.mail"></el-input>
        </el-form-item>
      </el-col>
